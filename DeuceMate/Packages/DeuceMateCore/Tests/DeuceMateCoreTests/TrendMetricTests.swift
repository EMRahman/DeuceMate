...
final class TrendMetricTests: XCTestCase {
    ...
    private func makeSample(
        ...
        firstServesIn: Int = 14, firstServeWins: Int = 10, secondServePoints: Int = 6, secondServeWins: Int = 3,
        ...
        MatchTrendSample(
            ...
            secondServePoints: secondServePoints, secondServeWins: secondServeWins,
