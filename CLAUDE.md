...
| File | Lines | What |
|------|------:|------|
| `Views/PointsGraphView.swift` | ~1700 | Charts (points momentum + HR/steps overlays), including set-relative point selection with the full pre-point score and serving side. Heavily `MARK:`-sectioned. |
...
- **Very large files** (`ScoreViewModel` ~1.9k, `PointsGraphView` ~1.7k,
